...
const dummyNotifications: Record<NotificationTab, NotificationItem[]> = {
  All: [
    ...
    {
      type: "stats",
      text: "ranked 145th in leaderboard last week",
      time: "1h ago",
      user: { name: "Hao", avatar: "https://i.pravatar.cc/100?img=12" },
    ...
    {
      type: "house",
      text: "ranked #1 this week with 12,400 points",
      time: "1 day ago",
      house: { name: "Cloud House", avatar: "/Dashboard_Logo/cloud.png" },
      icon: <RiTeamLine />,
      color: "#aaa",
      status: "unread",
    },
